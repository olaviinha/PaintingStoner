...
3. Drag an image file from your computer and drop it on the image (Mona Lisa) to replace it. Alternatively you may click on <i>Paste image URL</i> to open a field in which you can paste an URL to an image file somewhere online.
