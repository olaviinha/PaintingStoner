...
3. Drag any image file from your computer and drop it on the current image replace it. Alternatively you may click on <i>Paste image URL</i> to use an image from the interwebs.
